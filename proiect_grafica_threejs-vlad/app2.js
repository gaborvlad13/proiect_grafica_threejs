...
class BasicCharacterController {
  ...
  _LoadModels() {
    ...
    loader.load('alex.fbx', (fbx) => {
      ...
      loader.setPath('./resources/');
      loader.load('Walking.fbx',(a)=>{_OnLoad('sprint',a);});
      loader.load('Sneak Walk.fbx',(a)=>{_OnLoad('sneak',a);});
...
class CharacterFSM extends FiniteStateMachine {
  ...
  _Init() {
     	...
     	this._AddState('sneak',SneakState);
  }
};
...
class SneakState extends State{
      constructor(parent){
      super(parent);
      }
      get Name(){
      ...
      Enter(prevState){
       const curAction=this._parent._proxy._animations['sneak'].action;
       if(prevState) {
